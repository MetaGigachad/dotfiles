...
awful.util.tagnames = { "WEB", "DEV", "SYS", "MSG", "ETC" }
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "e", function () awful.spawn.with_shell("emacsclient -c") end,
            {description = "open new emacs frame", group = "launcher"}),
    -- Super + space to change keyboard layout
    awful.key({ modkey }, "space", function () kbdcfg.switch_next() end,
              {description = "change keyboard layout", group = "hotkeys"}),
    ...
    awful.key({ modkey, altkey, "Shift"   }, "space", function () awful.layout.inc(-1)                end,
...
awful.spawn.with_shell("pulseaudio-equalizer enable")
